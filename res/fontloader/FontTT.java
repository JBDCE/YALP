...
public class FontTT {
	 ...
	 * 
	 */
	public void drawText(String whatchars, float size, float x, float y, float z, Color4f color, float rotxpass, float rotypass, float rotzpass, boolean centered) {
	 ...
	 * 
	 */
	public void drawOutlinedText(String whatchars, float size, float x, float y, float z, Color4f color, Color4f outlinecolor, float rotxpass, float rotypass, float rotzpass, boolean centered) {
		float fontsizeratio = size/(float)fontsize;
	 ...
	 */
	private void drawtexture(Texture texture, float ratio, float x, float y, Color4f color, float rotx, float roty, float rotz) {
